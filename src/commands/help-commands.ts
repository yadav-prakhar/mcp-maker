...
export function displayMainHelp(): void {
  ...
  console.log('  mcp - CLI utility to create and manage TypeScript MCP servers');

  console.log(chalk.bold('\nSYNOPSIS'));
  console.log('  mcp [OPTION]... [COMMAND]');
  ...
  console.log(chalk.bold('\nEXAMPLES'));
  console.log(`  ${chalk.cyan('mcp create server my-server')}`);
  console.log('    Create a new MCP server project named "my-server"');
  console.log(`  ${chalk.cyan('mcp add tool my-tool')}`);
  console.log('    Add a new tool named "my-tool" to an existing MCP server');
  console.log(`  ${chalk.cyan('mcp add service my-service')}`);
...
export function displayCreateHelp(): void {
  console.log(chalk.bold('\nNAME'));
  console.log('  mcp create - Create new components');

  console.log(chalk.bold('\nSYNOPSIS'));
  console.log('  mcp create [OPTION]... COMMAND');
  ...
  console.log(`  ${chalk.cyan('mcp create server my-server')}`);
  console.log('    Create a new MCP server project named "my-server"');
  console.log(`  ${chalk.cyan('mcp create server my-server --http --port 3000')}`);
...
export function displayCreateServerHelp(): void {
  console.log(chalk.bold('\nNAME'));
  console.log('  mcp create server - Create a new MCP server project');

  console.log(chalk.bold('\nSYNOPSIS'));
  console.log('  mcp create server [OPTION]... [NAME]');
  ...
  console.log(`  ${chalk.green('-h, --help')}             display help information`);
  console.log(
    `  ${chalk.green('--http')}                 use HTTP transport instead of default stdio`
  );
  console.log(`  ${chalk.green('--cors')}                 enable CORS with wildcard (*) access`);
  console.log(
    `  ${chalk.green('--port')} <number>        specify HTTP port (only valid with --http)`
  );
  ...
  console.log(`  ${chalk.cyan('mcp create server my-server --http --cors')}`);
  console.log('    Create with HTTP transport and CORS enabled');
  console.log(`  ${chalk.cyan('mcp create server my-server --no-install')}`);
...
export function displayAddHelp(): void {
  console.log(chalk.bold('\nNAME'));
  console.log('  mcp add - Add components to an existing MCP server');

  console.log(chalk.bold('\nSYNOPSIS'));
  console.log('  mcp add [OPTION]... COMMAND');
  ...
  console.log(
    `  ${chalk.green('service')}             Add a new service to an existing MCP server`
  );
...
export function displayAddToolHelp(): void {
  console.log(chalk.bold('\nNAME'));
  console.log('  mcp add tool - Add a new tool to an existing MCP server');

  console.log(chalk.bold('\nSYNOPSIS'));
  console.log('  mcp add tool [OPTION]... [NAME]');
  ...
  console.log(
    `  ${chalk.green(
      'NAME'
    )}                 Name of the tool (optional, will prompt if not provided)`
  );
...
export function displayAddServiceHelp(): void {
  console.log(chalk.bold('\nNAME'));
  console.log('  mcp add service - Add a new service to an existing MCP server');

  console.log(chalk.bold('\nSYNOPSIS'));
  console.log('  mcp add service [OPTION]... [NAME]');
  ...
  console.log(
    `  ${chalk.green(
      'NAME'
    )}                 Name of the service (optional, will prompt if not provided)`
  );
