...
export function helpGeneral(): void {
	...
	console.log("  mcp-maker [command] [subcommand] [options]\n");
	...
	console.log(`  ${chalk.cyan("mcp-maker create server my-server")}     Create a new MCP server project`);
	console.log(`  ${chalk.cyan("mcp-maker add tool my-tool")}            Add a new tool to an existing MCP server`);
	console.log(`  ${chalk.cyan("mcp-maker add service my-service")}       Add a new service to an existing MCP server`);
	console.log(`  ${chalk.cyan("mcp-maker help create server")}           Display help for the create server command\n`);

	console.log(chalk.bold("For more information:"));
	console.log(`  Run ${chalk.cyan("mcp-maker help [command] [subcommand]")} for detailed help on a specific command\n`);
}
...
export function helpCreate(): void {
	...
	console.log(chalk.bold("USAGE:"));
	console.log("  mcp-maker create [subcommand] [options]\n");
	...
	console.log(chalk.bold("EXAMPLES:"));
	console.log(`  ${chalk.cyan("mcp-maker create server my-server")}     Create a new MCP server project`);
	console.log(`  ${chalk.cyan("mcp-maker create server my-server --http --port 3000")}     Create a server with HTTP transport\n`);

	console.log(chalk.bold("For more information:"));
	console.log(`  Run ${chalk.cyan("mcp-maker help create server")} for detailed help on the create server command\n`);
}
...
export function helpCreateServer(): void {
	...
	console.log(chalk.bold("USAGE:"));
	console.log("  mcp-maker create server [name] [options]\n");
	...
	console.log(chalk.bold("EXAMPLES:"));
	console.log(`  ${chalk.cyan("mcp-maker create server my-server")}     Create a new MCP server with stdio transport`);
	console.log(`  ${chalk.cyan("mcp-maker create server my-server --http --port 3000")}     Create with HTTP transport on port 3000`);
	console.log(`  ${chalk.cyan("mcp-maker create server my-server --http --cors")}     Create with HTTP transport and CORS enabled`);
	console.log(`  ${chalk.cyan("mcp-maker create server my-server --no-install")}     Create without installing dependencies\n`);
...
export function helpAdd(): void {
	...
	console.log(chalk.bold("USAGE:"));
	console.log("  mcp-maker add [subcommand] [options]\n");
	...
	console.log(chalk.bold("For more information:"));
	console.log(`  Run ${chalk.cyan("mcp-maker help add tool")} or ${chalk.cyan("mcp-maker help add service")} for detailed help\n`);
}
...
export function helpAddTool(): void {
	...
	console.log(chalk.bold("USAGE:"));
	console.log("  mcp-maker add tool [name]\n");

	console.log(chalk.bold("ARGUMENTS:"));
	console.log(`  ${chalk.green("name")}       Name of the tool (optional, will prompt if not provided)\n`);

	console.log(chalk.bold("EXAMPLES:"));
	console.log(`  ${chalk.cyan("mcp-maker add tool my-tool")}     Add a new tool named "my-tool"\n`);
...
export function helpAddService(): void {
	...
	console.log(chalk.bold("USAGE:"));
	console.log("  mcp-maker add service [name]\n");

	console.log(chalk.bold("ARGUMENTS:"));
	console.log(`  ${chalk.green("name")}       Name of the service (optional, will prompt if not provided)\n`);

	console.log(chalk.bold("EXAMPLES:"));
	console.log(`  ${chalk.cyan("mcp-maker add service my-service")}     Add a new service named "my-service"\n`);
