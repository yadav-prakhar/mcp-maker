...
export function helpGeneral(): void {
  ...
  console.log(
    `  ${chalk.cyan('mcp add tool my-tool')}            Add a new tool to an existing MCP server`
  );
  console.log(
    `  ${chalk.cyan(
      'mcp add service my-service'
    )}       Add a new service to an existing MCP server`
  );
  console.log(
    `  ${chalk.cyan(
      'mcp help create server'
...
export function helpCreate(): void {
  ...
  console.log(
    `  ${chalk.cyan(
      'mcp create server my-server --http --port 3000'
    )}     Create a server with HTTP transport\n`
  );

  console.log(chalk.bold('For more information:'));
  console.log(
    `  Run ${chalk.cyan('mcp help create server')} for detailed help on the create server command\n`
  );
}
...
export function helpCreateServer(): void {
  ...
  console.log(
    `  ${chalk.green('name')}       Name of the project (optional, will prompt if not provided)\n`
  );
  ...
  console.log(
    `  ${chalk.cyan(
      'mcp create server my-server --http --port 3000'
    )}     Create with HTTP transport on port 3000`
  );
  console.log(
    `  ${chalk.cyan(
      'mcp create server my-server --http --cors'
    )}     Create with HTTP transport and CORS enabled`
  );
  console.log(
    `  ${chalk.cyan(
      'mcp create server my-server --no-install'
...
export function helpAdd(): void {
  ...
  console.log(chalk.bold('For more information:'));
  console.log(
    `  Run ${chalk.cyan('mcp help add tool')} or ${chalk.cyan(
      'mcp help add service'
    )} for detailed help\n`
  );
}
...
export function helpAddTool(): void {
  ...
  console.log(chalk.bold('ARGUMENTS:'));
  console.log(
    `  ${chalk.green('name')}       Name of the tool (optional, will prompt if not provided)\n`
  );
...
export function helpAddService(): void {
  ...
  console.log(chalk.bold('ARGUMENTS:'));
  console.log(
    `  ${chalk.green('name')}       Name of the service (optional, will prompt if not provided)\n`
  );

  console.log(chalk.bold('EXAMPLES:'));
  console.log(
    `  ${chalk.cyan('mcp add service my-service')}     Add a new service named "my-service"\n`
  );
